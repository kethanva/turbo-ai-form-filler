...
# Script to launch Chrome with the turbo-ai-form-filler extension
...
echo -e "${GREEN}🚀 turbo-ai-form-filler - Chrome Launcher${NC}"
echo ""
...
if [ "$CHROME_TYPE" = "stable" ]; then
    ...
    echo ""
    echo -e "${CYAN}Step 4:${NC} The 'turbo-ai-form-filler' extension should now appear!"
    echo ""
    echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}"
    echo ""
    ...
    echo ""
    echo -e "${YELLOW}🚀 Launching Chrome with turbo-ai-form-filler extension...${NC}"
    ...
    echo "   3. Look for 'turbo-ai-form-filler' in the list"
fi
